...
export const experiences: Experience[] = [
  {
    ...
    shortBullets: [
      'Architecting backend services in .NET Web API for an enterprise workforce-management platform with complex business logic and third-party integrations.',
      'Architected and delivered WPF desktop tooling for production operations — improved feature turnaround and cut defect resolution time through cleaner UI component design and faster issue isolation.',
      'Optimized SQL Server schema design and high-volume query paths via LLBGen-based data access patterns, improving response consistency for data-heavy workflows.',
      'Engineered Angular integrations with multiple third-party systems — reducing manual handoffs and improving reliability across cross-system business processes.',
    ],
